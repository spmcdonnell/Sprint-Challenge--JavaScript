...
console.log("The" + tyr.name + "weighed " + tyr.weight + ".");

// What was the diet of a velociraptor?
console.log("The" + velo.name + "had a " + velo.diet + " diet.");

// How long was a stegosaurus?
console.log("The" + steg.name + "was " + steg.length + " long.");

// What time period did tyrannosaurus live in?
console.log("The" + tyr.name + "lived during the " + tyr.period + " period.");
...
console.log("The " + tyr.name + " says " + tyr.roar());
...
graduates.forEach(graduate => {
    if (graduate.university.indexOf("Uni") >= 0) {
